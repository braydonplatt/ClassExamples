...
each(names, function(item, indice){
  console.log('The item in the ' + indice + ' position is ' + item)
    ...
    getUserById = function (arr, str, callback) {
        for (var i = 0; i < arr.length; i++) {
            if (arr[i].id === str);
            callback(arr[i]);
...
//below you're given a function that will return a random
// number between 0 and 30 and an array full of numbers
// 'randomArray'. Your job is to write a function that
// will get a random number, then loop through the array
// to see if that random number is in the array. If it is,
